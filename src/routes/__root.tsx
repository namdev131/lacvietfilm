...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "twitter:title", content: "Lạc Việt Cinema – Hồn Việt trong từng khung hình" },
      { name: "twitter:description", content: "Xem phim trực tuyến tại Lạc Việt Cinema với kho phim đa dạng, nhiều nguồn phát, chuyển server thông minh và giao diện đậm bản sắc văn hóa Việt." },
      { property: "og:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/2cRuNHQklHcn5F2EPhTiwqXlugg1/social-images/social-1785731711596-social-image.webp" },
      { name: "twitter:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/2cRuNHQklHcn5F2EPhTiwqXlugg1/social-images/social-1785731711596-social-image.webp" },
    ],
    links: [
